...
const CallList = ({ type }: { type: "ended" | "upcoming" | "recordings" }) => {
  ...
  const getNoCallsNotification = () => {
    switch (type) {
      case "ended":
        return "There is no previous calls";
      case "upcoming":
        return "There is no upcoming calls";
      case "recordings":
        return "There is no recordings";
      default:
        return '';
    }
  };
  ...
  const noCallsMessage = getNoCallsNotification()
